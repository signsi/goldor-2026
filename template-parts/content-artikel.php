		...
		<?php
			...
			<?php } else {
				...
				echo "<p class='entry-cut'>";
					echo substr( wp_strip_all_tags(get_the_content(),false) , 0, 700) . "&#8239;.&#8239;.&#8239;. <span class='entry-cut-info'><a href='goldor-bestellen'>   " . __('werden Sie Abonnent, um weiterzulesen.','goldor') . " </a></span>";
				echo "</p>"; ?>
