...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital@0;1&family=Work+Sans:ital,wght@0,300;1,300&display=swap" rel="stylesheet">
	...
	<link rel="mask-icon" href="<?php echo get_stylesheet_directory_uri(); ?>/img/favicons/safari-pinned-tab.svg" color="#e6007e">
	...
	<div id="page" class="site">
		...
		<header id="masthead" class="site-header" role="banner">
			...
			<nav id="site-navigation" class="main-navigation" role="navigation">
				<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e('Primary Menu', 'goldor'); ?></button>
		...
		<div class="entry-nav">
			<ul>
				<?php if (is_single()) :
					...
					<li><a href="#" onclick="window.history.go(-1);" class="list-more-"><?php _e('Zurück', 'goldor'); ?></a></li>
		...
		?>
				<div class="top-story" style="background-image:url(<?php echo $thumb_url[0]; ?>)" onclick="location.href='<?php echo $link; ?>'">
