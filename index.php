...
$hasMedRectAd = $loopWerbung->have_posts();
...
$args = array(
	'post_type' => 'post',
	'posts_per_page' => $hasMedRectAd ? 2 : 3,
	'meta_query' => array(
...
<div id="primary" class="content-area">
	<main id="main" class="site-main" role="main">
		...
		<div class="grid">
			...
			<div class="story--top">
				...
				if (is_front_page() && is_home()):
					get_template_part('template-parts/stories/story', 'top');
				else:
				endif;
				?>
			...
			while ($loop->have_posts()):
				$loop->the_post(); ?>
				<div class="story--<?php echo $index; ?>">
					<?php include 'template-parts/grid-item.php'; ?>
				</div>
		...
		<div class="grid-container">
			...
			if ($hasMedRectAd) {
				get_template_part('template-parts/ads/ad', 'md-rect-news');
			}
		...
		<div class="grid-container">
			<div class="grid-item">
				...
				<a href="jobs/stelleninserate?filterselect=<?php echo $category->term_id ?>"
					class="list-more"><?php _e('All entries', 'goldor'); ?></a>
			</div>
			...
			<?php else:
				...
				while ($loop->have_posts()):
					...
					<div class="grid-item">
						<a href="<?php echo str_replace('http://http://', 'http://', 'http://' . $link); ?>"
							target="_blank"><img class="ad-stellen" width="300" height="250" class="ad"
								src="<?php echo $thumb_url[0]; ?>" title="<?php the_title(); ?>" class="item-image"></a>
					</div>
				<?php endwhile;
			endif; ?>
		...
		<div class="grid-container">
			...
			while ($loopVSGU->have_posts()):
				...
				<div class="grid-item">
					<div class="item-image" style="background-image:url(<?php echo $thumb_url[0]; ?>)"
			...
			if ($has_vsgu):
				$args = array('post_type' => array('kalender'), 'posts_per_page' => 1, 'meta_query' => array(array('key' => 'topentry', 'value' => '1', 'compare' => '==')));
			else:
				$args = array('post_type' => array('lieferant', 'kalender'), 'posts_per_page' => 2, 'meta_query' => array(array('key' => 'topentry', 'value' => '1', 'compare' => '==')));
			endif;
			$loop = new WP_Query($args);
			while ($loop->have_posts()):
				$loop->the_post();
			...
			<div class="grid-item">
				...
				while ($loop->have_posts()):
					...
					if ($myDateTimeEnd):
						$newDateEnd = $myDateTimeEnd->format('d.m.Y');
					endif;
					?>
					...
					<div class="list-item">
						...
						<p><?php echo substr(get_the_excerpt(), 0, 75) ?>&#8239;.&#8239;.&#8239;.&nbsp;&nbsp;&nbsp;<a
								class="article-more"
								href="<?php echo get_post_permalink(); ?>"><?php _e('mehr', 'goldor'); ?></a></p>
					</div>
				<?php endwhile; ?>
