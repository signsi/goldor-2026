...
@if (App\is_plugin_active_and_available('polylang/polylang.php') && has_nav_menu('language_switcher'))
    {!! wp_nav_menu([
        ...
        'container_class' => '',
        'add_li_class' => 'relative text-' . $color .' text-sm pr-3 pl-0 mr-3 last:pr-0 last:mr-0 border-r border-r-' . $color . ' border-solid last:border-r-0 transition-colors hover:text-primary',
    ]) !!}
@endif
