        ...
        <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
            <nav class="flex space-x-10">
                ...
                {!! wp_nav_menu([
                    ...
                    'container_class' => '',
                    'add_li_class' => 'text-base font-medium text-gray-500 hover:text-gray-900',
          ...
          -->
                    <div class="absolute z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-3xl invisible">
                        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                            <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
                                ...
                                <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Connect with third-party tools that
                                ...
                                <a href="#" class="-m-3 p-3 flex items-start rounded-lg hover:bg-gray-50">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="mt-1 text-sm text-gray-500">Get detailed reports that will help you
                            ...
                            <div class="p-5 bg-gray-50 sm:p-8">
                                <a href="#" class="-m-3 p-3 flow-root rounded-md hover:bg-gray-100">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Empower your entire team with even more
                                        advanced tools.</p>
                                </a>
                            </div>
                        </div>
          ...
          -->
                    <div
                        class="absolute z-10 left-1/2 transform -translate-x-1/2 mt-3 px-2 w-screen max-w-xs sm:px-0 invisible">
                        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                            <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                ...
                                <a href="#" class="-m-3 p-3 block rounded-md hover:bg-gray-50">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">Learn how to maximize our platform to get the
                                        most out of it.</p>
                                </a>

                                <a href="#" class="-m-3 p-3 block rounded-md hover:bg-gray-50">
                                    <p class="text-base font-medium text-gray-900">Events</p>
                                    <p class="mt-1 text-sm text-gray-500">See what meet-ups and other events we might
                                        be planning near you.</p>
                                </a>
