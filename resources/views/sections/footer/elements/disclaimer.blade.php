@php
    ...
    $list_item_class = 'relative text-xs hover:text-primary transition-colors pr-3 border-r last:pr-0 last:border-r-0';
    ...
    <nav>
        @php
            $menu_args = [
                ...
                'menu_class' => 'flex space-x-3 my-0 pl-0 ' . $disclaimer_alignment,
