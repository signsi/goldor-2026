    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            ...
            <div class="mt-8 xl:mt-0">
                ...
                <p class="mt-4 text-base text-gray-500">Brandaktuelle Neuigkeiten, Beiträge und Inhalte direkt in deinem
                    Postfach.
                </p>
                <form class="mt-4 sm:flex sm:max-w-md">
                    ...
                    <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                        <button type="submit"
                            class="w-full bg-theme flex items-center justify-center border border-transparent rounded-md py-2 px-4 text-base font-medium text-white hover:bg-theme/70 focus:ring-2 focus:ring-offset-2 focus:ring-theme">Anmelden</button>
                    </div>
                </form> --}}
