...
<footer aria-labelledby="footer-heading">
    <div class="has-secondarydark-background-color has-background">
        ...
        <div class="max-w-default 2xl:max-w-xlarge px-gutter py-element mx-auto">
    ...
    <div class="has-secondary-background-color has-background" aria-labelledby="footer-heading">
        ...
        <div class="footerDisclaimer max-w-default 2xl:max-w-xlarge px-gutter py-2.5 mx-auto">
            <nav>
                @php
