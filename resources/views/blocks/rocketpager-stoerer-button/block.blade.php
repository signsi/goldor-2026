...
@section('content-section')
    ...
    <div class="transition-all h-36 w-36 xl:h-44 xl:w-44 block aspect-square overflow-hidden p-5 xl:p-6 2xl:p-7 bg-white rounded-full drop-shadow-md hover:drop-shadow-xl hover:scale-105 hover:rotate-12">
