...
@include('blocks.helpers.background-image',
    [
        ...
        'class_object_fill_breakpoint' => 'md:bg-object-container',     -> Klasse gibt an, ab welcher Bildschrimgrösse der Hintergrund dargestellt werden soll. (Es können zusätzliche Klassen für den Wrapper angegeben werden).
        'class_object_fit' => array('class' => 'bg-cover'),             -> Klasse gibt an, wie das Bild die Fläche ausfüllen soll (contain, cover usw.). (Es können zusätzliche Klassen für das Bild angegeben werden).
...
@php
    ...
    $class_object_fill_breakpoint = $class_object_fill_breakpoint ? $class_object_fill_breakpoint : 'md:bg-object-container';
    $class_object_fit = array_key_exists('class', $class_object_fit) ? $class_object_fit : array('class' => 'bg-cover');
@endphp
