...
@section('content-section')
    <div class="grid gap-gutter {{ $row_per_col }}">
        @while (block_rows('icon'))
            ...
            @endphp
            <div class="bg-secondary border-3 border-secondary group hover:bg-white hover:border-primary flex flex-col justify-between group p-5 text-center md:text-left no-underline">
